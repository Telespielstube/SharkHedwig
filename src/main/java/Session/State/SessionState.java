...
public interface SessionState {
     ...
     */
    Optional<Message.Message> handle(Messageable message, ProtocolRole protocolRole, ShippingLabel shippingLabel, DeliveryContract deliveryContract, String sender);
