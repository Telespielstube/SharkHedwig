...
public interface SessionState {
     ...
     */
    Optional<Message.Message> handle(Messageable message, ProtocolRole protocolRole, ShippingLabel shippingLabel, DeliveryContract deliveryContract, GeoSpatial geoSpatial, String sender);
