...
//    }
    ...
    @Test
    public void setupHedwigComponent() throws NoSuchFieldException, NoSuchPaddingException, NoSuchAlgorithmException, IOException, SharkException {
        SharkHedwigComponent sharkHedwig = new SharkHedwigComponent(sharkPKIComponent);
    }
